...
import { Animated, Platform, ScrollView, TouchableHighlight, TouchableNativeFeedback, View } from 'react-native';
...
function AnimationImage({ image, width, style }) {
  ...
  return (
    <Animated.View onLayout={() => setOpacity()} style={[{ width, opacity: fadeAnim }, style]}  ><View style={{ width }} ><Img w='100%' style={{ resizeMode: 'stretch' }} h={300} src={{uri:`${localhost}/upload/slider/${image}`}} /></View></Animated.View>
  )
}
